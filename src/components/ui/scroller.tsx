...
const scrollerVariants = cva("", {
  variants: {
    orientation: {
      ...
      horizontal: [
        "overflow-x-auto",
        "data-[left-scroll=true]:mask-[linear-gradient(270deg,#000_calc(100%-var(--scroll-shadow-size)),transparent)]",
        "data-[right-scroll=true]:mask-[linear-gradient(90deg,#000_calc(100%-var(--scroll-shadow-size)),transparent)]",
        "data-[left-right-scroll=true]:mask-[linear-gradient(to_right,#000,#000,transparent_0,#000_var(--scroll-shadow-size),#000_calc(100%-var(--scroll-shadow-size)),transparent)]",
      ],
    },
    hideScrollbar: {
